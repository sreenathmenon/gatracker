...
<html>
    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 center">
                    <h1 class="center white">Google Analytics Tracker</h1>
                    <p class="center white"> Enter the website from which Scrapping is to be performed </p>
            ...
            <div class="row">
                ...
                <div id="fail" class="alert alert-danger">Couldn't find any GA data</div>
        ...
        <script>
            ...
            //  
            //  
            //$("#scrap_me_btn").click(function(event) {
            //
            //    event.preventDefault();
            //    $(".alert").hide();
            //    
            //    if ($("#site_url").val()!= "") {
            //        $.get('iamthebest.php?site_url='+$("#site_url").val(), function(data) {
            //            if(data=="") {
            //                $("#fail").fadeIn();
            //            } else {
            //                $("#success").html(data).fadeIn();
            ...
            //    event.preventDefault();
            //$.ajax({
            //            url: APP_URL+'/loading?url=' + siteUrl,
            //            dataType: "json",
            //            
            //           beforeSend: function() {
            //               
            ...
            //
            //                //Fetch the current progress % every 2s and display the corresponding values in frontend
            //                //if (loadingProgress) {
            //                    setInterval(displayPercentage(siteUrl), 2000);
            //                    $("#result").html(data.value);
            //                    $('.progress-bar').attr('aria-valuenow', data.value).attr('style', 'width : ' + data.value + '%');
            //                    $('.sr-only').text( data.value +'%' );
